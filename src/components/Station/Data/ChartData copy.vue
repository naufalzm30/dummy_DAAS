...
export default {
  name: "Slider",
  props: ["debitData", "debitLabel", "stations", "status", "ava_width",],
  components: {
    LineChart,
    TotalChart
  },
  ...
  methods: {
    renderChart() {
      if (this.$refs.chart && this.debitData.length > 0) {
        this.$refs.chart.renderChart({
          labels: this.debitLabel,
          datasets: [
            {
