  ...
  <div>
    ...
    <div class="mobile-width">
      <div class="d-flex justify-content-between align-items-center">
        <div class="subTitle">Daftar Logger</div>
        <div>
          <router-link
                ...
                <dataset-item tag="tbody">
                  <template #default="{ row, rowIndex }">
                    <tr>
                      ...
                      <td>{{ row.logger_ver }}</td>
                      <td>{{ row.max_channel }}</td>
                      <td>{{ row.max_analog }}</td>
                      <td>{{ row.max_digital }}</td>
...
export default {
  ...
  methods: {
    ...
    async delete(id) {
      await axios
        .delete(`${this.$baseURL}/logger-type/` + id, {
          headers: {
            Authorization: `Token ${this.token}`,
          },
        })
