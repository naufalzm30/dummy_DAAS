  ...
  <div>
    ...
    <div class="mobile-width">
      <div class="d-flex justify-content-between align-items-center">
        <div class="subTitle">Daftar Provinsi</div>
        <div>
          <router-link
...
export default {
  ...
  methods: {
    ...
    async loadData() {
      await axios
        .get(`${this.$baseURL}/provinsi/`, {
          headers: {
            Authorization: `Token ${this.token}`,
          },
        })
        .then((r) => {
          this.provinsi = r.data;
        });
    },
    async delete(id) {
      await axios
        .delete(`${this.$baseURL}/provinsi/` + id, {
          headers: {
            Authorization: `Token ${this.token}`,
          },
        })
